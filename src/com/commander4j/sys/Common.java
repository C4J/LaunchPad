...
public class Common {
	...
	public final static ImageIcon app_icon_dialog = new ImageIcon("."+File.separator+"images"+File.separator+"icons"+File.separator+"LaunchPad_Icons"+File.separator+"MyIcon.iconset"+File.separator+"icon_48x48.png");
	...
	public final static ImageIcon icon_up = new ImageIcon(iconPath+"/up-arrow_24x24.png");
	public final static ImageIcon icon_structure = new ImageIcon(iconPath+"/structure_24x24.png");
	public final static ImageIcon icon_down = new ImageIcon(iconPath+"/down-arrow_24x24.png");
