...
import com.commander4j.launchpad.JLaunchPad;
...
public class JLicenseInfo implements Comparable<JLicenseInfo>
{
	...
	public LinkedList<JLicenseInfo> getLicences()
	{
		...
		JLicenseInfo test = new JLicenseInfo("Menu4j","GNU General Public License V2.txt",JLaunchPad.version,"GNU General Public License V2");
